    ...
    <?php
    if(isset($_SESSION['order'])) // Relates to add-admin.php
        {
    ...
    <section class = "food-menu">
        <div class = "container">
            ...
            //  Query to get items from database that are active and featured.
...
<!--                 <div class = "food-menu-box">
        ...
        <p class = "text-center">
            <a href = "foods.php"> Check out our full menu</a>
        </p>
    </section>
